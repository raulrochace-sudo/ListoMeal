...
import os, json, re, base64, base64
...
def recipe_image():
    ...
    prompt = f"""
Photorealistic appetizing food photography of the finished dish: {title}.
Recipe description: {summary}
Main ingredients actually used: {ingredient_text}

Show the exact finished meal implied by this recipe.
Do not add prominent ingredients that are not listed.
Warm natural lighting, realistic textures, casual family dinner plating.
No text, labels, packaging, logos, or hands.
Show the finished dish clearly and make it look genuinely appetizing.
"""
