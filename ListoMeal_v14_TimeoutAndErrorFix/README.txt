...
LISTOMEAL V14 RENDER START COMMAND
Use this exact Start Command in Render:

gunicorn --bind 0.0.0.0:$PORT --timeout 120 server:app

The longer timeout is important because AI recipe/image requests can take longer than the default worker timeout.
